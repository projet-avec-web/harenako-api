...
@NoArgsConstructor
@AllArgsConstructor
public class ArgentObjectMapper
    implements ObjectMapper<Argent, com.harenako.api.endpoint.rest.model.Argent> {
  ...
  public com.harenako.api.endpoint.rest.model.Argent toRestModel(Argent argent) {
    if (argent == null) return null;
    return new com.harenako.api.endpoint.rest.model.Argent()
        .nom(argent.getNom())
        .devise(deviseObjectMapper.toRestModel(argent.getDevise()))
        .dateDOuverture(argent.getDateOuverture())
        .valeurComptable(argent.getValeurComptable());
  }
}
