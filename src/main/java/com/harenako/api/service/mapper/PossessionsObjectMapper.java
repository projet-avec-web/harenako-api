...
@Component
@AllArgsConstructor
public class PossessionsObjectMapper implements ObjectMapper<Set<Possession>, List<com.harenako.api.endpoint.rest.model.PossessionAvecType>> {
    ...
    @Override
    public List<com.harenako.api.endpoint.rest.model.PossessionAvecType> toRestModel(Set<Possession> possessions) {
    ...
    public List<com.harenako.api.endpoint.rest.model.PossessionAvecType> toRestModel(List<Possession> possessions) {
        List<PossessionAvecType> possessionAvecTypeList = new ArrayList<>();
