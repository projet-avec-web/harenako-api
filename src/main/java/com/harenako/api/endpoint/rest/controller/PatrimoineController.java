...
public class PatrimoineController {
  ...
  public ResponseEntity<?> getPatrimoine(@PathParam("page") Integer page, @PathParam("pageSize") Integer pageSize) {
    return ResponseEntity.ok("get patrimoines");
  }

  @GetMapping("/patrimoines/{nom_patrimoine}")
  public ResponseEntity<?> getPatrimoineByNom(@PathVariable("nom_patrimoine") String nom_patrimoine) {
