...
import school.hei.poja.endpoint.EndpointConf;
import school.hei.poja.endpoint.event.EventConf;
import school.hei.poja.endpoint.event.consumer.EventConsumer;
import school.hei.poja.endpoint.event.consumer.model.ConsumableEvent;
import school.hei.poja.endpoint.event.consumer.model.ConsumableEventTyper;
...
public class MailboxEventHandler implements RequestHandler<SQSEvent, String> {
  ...
  private ConfigurableApplicationContext applicationContext(String... args) {
    ...
    application.setDefaultProperties(
        Map.of("server.port", SPRING_SERVER_PORT_FOR_RANDOM_VALUE));
